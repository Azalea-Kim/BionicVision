...
print(ims)
ims = [k for k in ims if 'frame' in k]
for imname in ims:
    print(imname)
    ...
    gray_result = cv2.cvtColor(colormap, cv2.COLOR_BGR2GRAY) # gray map
    res = im * 0.7 + colormap * 0.3 # image + colormap
    # res = gray_result
    # res = colormap
...
#run_spatialstream.py --trained_model D:\\egocentric-gaze-prediction-master\\pth\\spatial.pth.tar --trained_late D:\\egocentric-gaze-prediction-master\\pth\\late.pth.tar --dir D:\\2021-han-scene-simplification-master\\2021-han-scene-simplification-master\\output_frames\\kitchen_try